...
for subset in subsets[0:1]:
    ...
    model.compile(optimizer='rmsprop',loss='binary_crossentropy',metrics=[metric_recall])
    ...
    np.savetxt('Results/recall_1.txt',recall)


    plt.plot(recall, range(1,51), marker='o')
